...
fetch('/api/books')
    ...
    .then(data => {
        ...
        const hideMainPageSections = () => {
            const sectionsToHide = [document.querySelector('.hero-section-background'), document.querySelector('.zhvillim'), ...document.querySelectorAll('.container'), document.querySelector('.rekomandimet'), document.querySelector('.lib-femije-seksion-bg'), document.querySelector('.autor-dinamik-mbajtesi'), document.querySelector('.seksion-oferte')];
        ...
        window.addEventListener('popstate', function (event) {
            const mainPageSections = [document.querySelector('.hero-section-background'), document.querySelector('.zhvillim'), ...document.querySelectorAll('.container'), document.querySelector('.rekomandimet'), document.querySelector('.lib-femije-seksion-bg'), document.querySelector('.autor-dinamik-mbajtesi'), document.querySelector('.seksion-oferte')];
...
function initInfoLinks() {
    ...
    const mainContentSections = [document.querySelector('.hero-section-background'), document.querySelector('.zhvillim'), ...document.querySelectorAll('.container'), document.querySelector('.rekomandimet'), document.querySelector('.lib-femije-seksion-bg'), document.querySelector('.autor-dinamik-mbajtesi'), document.querySelector('.seksion-oferte'), document.getElementById('koherenc')];
